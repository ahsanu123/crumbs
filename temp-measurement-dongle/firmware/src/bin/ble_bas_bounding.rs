...
static DESC: [u8; 67] = [
    ...
    117u8, 1u8, 149u8, 8u8, 129u8, 2u8, 21u8, 0u8, 38u8, 255u8, 0u8, 117u8, 8u8, 149u8, 1u8, 129u8,
    3u8, 5u8, 8u8, 25u8, 1u8, 41u8, 5u8, 37u8, 1u8, 117u8, 1u8, 149u8, 5u8, 145u8, 2u8, 149u8, 3u8,
    145u8, 3u8, 5u8, 7u8, 25u8, 0u8, 41u8, 221u8, 38u8, 255u8, 0u8, 117u8, 8u8, 149u8, 6u8, 129u8,
    0u8, 192u8,
];
...
/// Run the BLE stack.
pub async fn ble_bas_peripheral_bonding_run<C, RNG, S>(
    controller: C,
    ...
    S: NorFlash,
{
    ...
    let _ = join(ble_task(runner), async {
        loop {
            match advertise("tmd", &mut peripheral, &server).await {
                Ok(conn) => {
...
async fn main(_s: Spawner) {
    ...
    ble_bas_peripheral_bonding_run(controller, &mut trng, &mut flash).await;
}

use crate::display_models::{st7735s_modified::ST7735s, st7789_modified::ST7789};
use core::convert::Infallible;
use embedded_hal::digital::OutputPin;
use mipidsi::{Display, interface::Interface, models::ILI9341Rgb565};
...
impl<DI: Interface<Word = u8>, RST: OutputPin<Error = Infallible>> LineBufferProvider
    for &mut DrawBuffer<Display<DI, ST7735s, RST>>
{
    type TargetPixel = Rgb565Pixel;
...
impl<DI: Interface<Word = u8>, RST: OutputPin<Error = Infallible>> LineBufferProvider
    for &mut DrawBuffer<Display<DI, ILI9341Rgb565, RST>>
{
    type TargetPixel = Rgb565Pixel;
